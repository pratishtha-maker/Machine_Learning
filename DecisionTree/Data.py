...
def load_data(dir_loc, train,param):
    ...
    if train:
        ...
        CSVfile = "/Users/pratishthaagnihotri/Documents/Machine_Learning/HW_1/" + dir_loc + "/train.csv"
    else:
        CSVfile = "/Users/pratishthaagnihotri/Documents/Machine_Learning/HW_1/" + dir_loc + "/test.csv"
